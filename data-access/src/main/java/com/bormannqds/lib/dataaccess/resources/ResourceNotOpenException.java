...
public class ResourceNotOpenException extends IllegalStateException {
	...
	public ResourceNotOpenException(final String msg) {
		super(msg);
	}

	public ResourceNotOpenException(Throwable cause) {
		super(cause);
	}

	public ResourceNotOpenException(final String msg, Throwable cause) {
		super(msg, cause);
	}
}
