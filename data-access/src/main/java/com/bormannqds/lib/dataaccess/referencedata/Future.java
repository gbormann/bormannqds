...
public class Future extends Instrument {
	public Future(final Set<String> internalBaseSymbols, final Currency ccy, final double minPriceVariance, final double tickValue) {
		super(internalBaseSymbols, InstrumentType.Future, ccy);
	...
	public String toString() {
		return "Future [" + super.toString() + ", minPriceVar=" + minPriceVar + ", tickValue="
				+ tickValue + "]";
	}
